...
const Missions = {
  ...
  'jupiter-mars-flyby': {
    ...
    departureLabel: 'LEO',
    flybyAt: 'marte',
    description: 'Direta para Júpiter custa ~23 km/s. Sobrevoando Marte primeiro, dá pra reduzir pra ~14 km/s — o gravity assist em Marte adiciona energia heliocêntrica.',
    estimatedCost: 14.4,
    centralBody: 'sol',
